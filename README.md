...
pytest -q                        # ~2,311 collected, ~2,253 passed, ~25 skipped on a minimal env (exact counts vary)
...
Generated: 2026-09-18T09:34:18.800742  Horizon scenarios: 5  Passed: 4  Failed: 1
...
CONTINUUM is one library (`src/continuum`, 124 modules) plus a large test suite (161 test files, ~2,311 tests). All modules append to and replay one hash chained event log:

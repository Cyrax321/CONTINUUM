...
CONTINUUM is one library (`src/continuum`, 124 modules) plus a large test suite (200 test files, ~2,195 tests). All modules append to and replay one hash chained event log:

...
CONTINUUM is one library (`src/continuum`, 99 modules) plus a large test suite (161 test files, ~2,195 tests). All modules append to and replay one hash chained event log:

...
CONTINUUM is one library (`src/continuum`, 126 modules) plus a large test suite (172 test files, ~2,311 tests). All modules append to and replay one hash chained event log:

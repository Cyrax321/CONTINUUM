...
CONTINUUM is one library (`src/continuum`, 127 modules) plus a large test suite (178 test files, ~2,501 tests). All modules append to and replay one hash chained event log:

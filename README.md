...
CONTINUUM is one library (`src/continuum`, 124 modules) plus a large test suite (161 test files, ~4,444 tests). All modules append to and replay one hash chained event log:

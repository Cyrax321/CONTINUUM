...
EXPECTED: dict[tuple[str, int], tuple[str, str]] = {
    ("src/continuum/checkpoint/policy.py", 52): ("CheckpointTrigger", "decl"),
    ("src/continuum/checkpoint/policy.py", 62): ("RECOVERY", "assign"),
    ("src/continuum/checkpoint/manager.py", 174): ("checkpoint", "decl"),
    ("src/continuum/recovery/cleanup.py", 20): ("cleanup_ephemeral_artifacts", "decl"),
    ("src/continuum/concurrency/lease.py", 58): ("LeaseCoordinator", "decl"),
    ...
    ("src/continuum/recovery/impact.py", 48): ("DependencyGraph", "decl"),
    ("src/continuum/recovery/planner.py", 112): ("RepairPlan", "decl"),
    ("src/continuum/reconcilers.py", 297): ("probe_authority_verdict", "decl"),
    ("src/continuum/security/provenance.py", 19): ("TrustLevel", "assign"),
    ("src/continuum/provenance_map.py", 60): ("CanonicalProvenance", "decl"),
    ("src/continuum/state/validator.py", 222): ("StateValidator", "decl"),
    ("src/continuum/adapters/actions.py", 24): ("AdapterAction", "decl"),
    ("src/continuum/adapters/actions.py", 53): ("run_action", "decl"),
    ("src/continuum/models.py", 97): ("StateStatus", "decl"),
    ("src/continuum/models.py", 192): ("Origin", "decl"),
    ("src/continuum/models.py", 227): ("EXTERNAL_MONITOR", "assign"),
    ("src/continuum/models.py", 1060): ("EnvResource", "decl"),
    ("src/continuum/models.py", 1072): ("EnvironmentSnapshot", "decl"),
    ("src/continuum/models.py", 1114): ("RecoveryContract", "decl"),
    ("src/continuum/models.py", 1188): ("StateCheckpoint", "decl"),
}

...
def main(
    ...
    *,
    ...
    # hooks and mcp doctor never touch a run, so they must not create an
    # empty database as a side effect (of editing a settings file, or of
    # probing a server with a throwaway one).

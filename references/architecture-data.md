...
RECOVERY_BLOCKED, REVIEW_CONFIRMED, REASONING_SUMMARY,
EVENT_LOG_ANCHORED, PERCEPTION_OBSERVED, BRANCH_RESOLVED,
ACTION_RECORDED, ACTION_RECONCILED, ACTION_COMPENSATED, GRANT_DENIED,
LIVENESS_SILENCE_DETECTED, LIVENESS_RECOVERED, RISK_OBSERVED,
AUTHORITY_CONSUMED, AUTHORITY_RECONCILED, ATTEMPT_LESSON,
TRAJECTORY_REPORT, PLAN_UPSERT, MEMORY_TOMBSTONED, NOTIFICATION_SENT,
NOTIFICATION_FAILED
```

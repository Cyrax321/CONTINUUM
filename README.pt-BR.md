...
pytest -q                        # ~2,241 coletados, ~2,030 passando, ~23 pulados em um ambiente mínimo (as contagens exatas variam)
...
O CONTINUUM é uma biblioteca (`src/continuum`, 124 módulos) mais uma suíte de testes grande (161 arquivos de teste, ~2,241 testes). Todos os módulos acrescentam e reproduzem um log de eventos encadeado:

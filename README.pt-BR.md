...
pytest -q                        # ~2,363 coletados, ~2,337 passando, ~26 pulados em um ambiente mínimo (as contagens exatas variam)
...
O CONTINUUM é uma biblioteca (`src/continuum`, 127 módulos) mais uma suíte de testes grande (172 arquivos de teste, ~2,363 testes). Todos os módulos acrescentam e reproduzem um log de eventos encadeado:
